...
public class FirebaseHelper {
    ...
    private final static String FIREBASE_URL = "https://android-chat-ude.firebaseio.com";
    ...
    public String getAuthUserEmail(){
        ...
        String email = null;
        if (authData != null){
            Map<String, Object> providerData = authData.getProviderData();//obtiene el email
